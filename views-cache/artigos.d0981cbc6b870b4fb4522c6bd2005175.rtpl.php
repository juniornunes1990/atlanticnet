...
<div class="content-box">
    ...
    <div class="element-box">
        ...
        <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
            ...
            <tbody>
                <?php $counter1=-1;  if( isset($artigos) && ( is_array($artigos) || $artigos instanceof Traversable ) && sizeof($artigos) ) foreach( $artigos as $key1 => $value1 ){ $counter1++; ?>
                <tr>
                    <td>Nenhum</td>
                    <td><?php echo htmlspecialchars( $value1["desartigo"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1["dtregister"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td width="10%" class="row-actions">
                        <a href="/admin/categories/<?php echo htmlspecialchars( $value1["idartigo"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="os-icon os-icon-ui-49"></i></a>
